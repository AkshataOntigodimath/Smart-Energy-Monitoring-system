...
- Abnormal usage and theft detection
...
6. The ESP32 detects abnormal usage conditions based on the programmed logic.
...
9. Monitoring data is transmitted to ThingSpeak through Wi-Fi.
